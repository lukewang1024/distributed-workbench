...
if (source !== destination) {
  for (const name of ['package.json', 'package-lock.json', 'node-runtimes.json', 'extension-host.mjs', 'host.mjs']) copyFileSync(path.join(source, name), path.join(destination, name));
}
